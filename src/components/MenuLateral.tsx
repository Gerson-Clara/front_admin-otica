...
import { FaGlasses, FaUsers } from "react-icons/fa6"
    ...
    <aside id="default-sidebar" className="fixed mt-24 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div className="h-full px-3 py-4 overflow-y-auto bg-blue-300 dark:bg-gray-800">
        ...
        <li>
          ...
          <li>
            <Link href="/principal/oculos" className="flex items-center p-2">
              <span className="h-5 text-gray-600 text-2xl">
                <FaGlasses />
              </span>
              <span className="ms-2 mt-1">Cadastro de Óculos</span>
            </Link>
          </li>
          <li>
          ...
          <li>
          <Link href="/principal/compras" className="flex items-center p-2 cursor-pointer">
              <span className="h-5 text-gray-600 text-2xl">
                <BsCashCoin />
              </span>
